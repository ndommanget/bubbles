# Automatically generated script: Sunday May 08, 14:21 2016
\set noalias = 1
...
oplocate -x 7.0202099999999996 -y 6.8018099999999997 shapes
...
oplocate -x 9.4391200000000008 -y 8.2178100000000001 forces
...
oplocate -x 0.0312436 -y -9.3818400000000004 attributeWrangle_solidAttraction
...
oplocate -x 2.0284499999999999 -y -12.384600000000001 attributeWrangle_solidStrongInteraction
...
oplocate -x -0.97497400000000001 -y -8.5843699999999998 attributeWrangle_solidDistance
opspareds "" attributeWrangle_solidDistance
opparm attributeWrangle_solidDistance  bindings ( 0 ) groupbindings ( 0 )
opparm attributeWrangle_solidDistance folder0 ( 0 0 ) group ( closeSolid ) grouptype ( points ) class ( point ) vex_numcount ( 10 ) vex_threadjobsize ( 1024 ) snippet ( 'f@solidDistance = length(v@toSolid);' ) exportlist ( * ) vex_strict ( off ) autobind ( on ) bindings ( 0 ) groupautobind ( on ) groupbindings ( 0 ) vex_cwdpath ( . ) vex_outputmask ( * ) vex_updatenmls ( off ) vex_matchattrib ( id )
...
# Node attributeWrangle_outside (Sop/attribwrangle)
opadd -e -n attribwrangle attributeWrangle_outside
oplocate -x 20.8292 -y 4.0139699999999996 attributeWrangle_outside
opspareds "" attributeWrangle_outside
opparm attributeWrangle_outside  bindings ( 0 ) groupbindings ( 0 )
opparm attributeWrangle_outside folder0 ( 0 0 ) group ( outside ) grouptype ( points ) class ( point ) vex_numcount ( 10 ) vex_threadjobsize ( 1024 ) snippet ( 'v@force += v@solidCollision;\nv@force += v@solidStrongInteraction;\nv@force += v@solidAttraction;\n\nv@force += v@strongInteraction;\nv@force += v@weakInteraction;\n\nv@force /= f@mass;\n' ) exportlist ( * ) vex_strict ( off ) autobind ( on ) bindings ( 0 ) groupautobind ( on ) groupbindings ( 0 ) vex_cwdpath ( . ) vex_outputmask ( * ) vex_updatenmls ( off ) vex_matchattrib ( id )
chlock attributeWrangle_outside -*
chautoscope attributeWrangle_outside -*
opcolor -c 0.80000001192092896 0.80000001192092896 0.80000001192092896 attributeWrangle_outside
opset -d off -r off -h off -f off -y off -t off -l off -s off -u off -c off -e on -b off attributeWrangle_outside
opexprlanguage -s hscript attributeWrangle_outside
opuserdata -n '___Version___' -v '' attributeWrangle_outside

# Node attributeWrangle_solidCollision (Sop/attribwrangle)
opadd -e -n attribwrangle attributeWrangle_solidCollision
oplocate -x 2.0284499999999999 -y -13.982900000000001 attributeWrangle_solidCollision
opspareds "" attributeWrangle_solidCollision
opparm attributeWrangle_solidCollision  bindings ( 0 ) groupbindings ( 0 )
opparm attributeWrangle_solidCollision folder0 ( 0 0 ) group ( outside ) grouptype ( points ) class ( point ) vex_numcount ( 10 ) vex_threadjobsize ( 1024 ) snippet ( 'v@solidCollision = ch("../controls/solidcollision") * v@toSolid;' ) exportlist ( * ) vex_strict ( off ) autobind ( on ) bindings ( 0 ) groupautobind ( on ) groupbindings ( 0 ) vex_cwdpath ( . ) vex_outputmask ( * ) vex_updatenmls ( off ) vex_matchattrib ( id )
chlock attributeWrangle_solidCollision -*
chautoscope attributeWrangle_solidCollision -*
opcolor -c 0.80000001192092896 0.80000001192092896 0.80000001192092896 attributeWrangle_solidCollision
opset -d off -r off -h off -f off -y off -t off -l off -s off -u off -c off -e on -b off attributeWrangle_solidCollision
opexprlanguage -s hscript attributeWrangle_solidCollision
opuserdata -n '___Version___' -v '' attributeWrangle_solidCollision

# Node pointWrangle_projectToSolid (Sop/attribwrangle)
opadd -e -n attribwrangle pointWrangle_projectToSolid
oplocate -x 6.2156700000000003 -y -13.982900000000001 pointWrangle_projectToSolid
...
oplocate -x 14.222899999999999 -y 0.40039599999999997 scatter_initialPoints
...
oplocate -x 14.1989 -y -4.6031199999999997 OUT_initialPoints
...
oplocate -x 10.8238 -y 2.0346199999999999 vdbFromPolygons
...
oplocate -x 10.800599999999999 -y -4.60107 OUT_liquidVelocity
...
oplocate -x 14.222899999999999 -y -0.40176299999999998 attributeCreate_pscale
opspareds "" attributeCreate_pscale
opparm attributeCreate_pscale  numattr ( 1 )
chblockbegin
chadd -t 0 0 attributeCreate_pscale value1v1
chkey -t 0 -v 0 -m 0 -a 0 -A 0 -T a  -F 0.0001 attributeCreate_pscale/value1v1
chblockend
...
oplocate -x 17.607199999999999 -y -4.6097000000000001 OUT_emissionGeometry
...
oplocate -x 10.8238 -y 3.6354199999999999 group_highVel
...
oplocate -x 11.5893 -y 4.4357499999999996 bound_band
...
oplocate -x 10.8246 -y -0.41060999999999998 delete_nonVelocity
...
oplocate -x 7.2141599999999997 -y -4.64236 OUT_liquidSurface
...
oplocate -x 21.807700000000001 -y 1.5785100000000001 attributeCreate_massLiquid
...
oplocate -x 21.807700000000001 -y 0.77984600000000004 attributeCreate_volume
...
oplocate -x 21.807700000000001 -y 2.37717 attributeCreate_radius
...
oplocate -x 21.807700000000001 -y 0.0147452 attributeCreate_massAir
...
oplocate -x 21.807700000000001 -y -4.5886800000000001 OUT_newPoints
...
oplocate -x 21.807700000000001 -y 6.0195100000000004 dopImport_newPoints
...
# Node facet_computeNormals (Sop/facet)
opadd -e -n facet facet_computeNormals
oplocate -x 7.2141599999999997 -y -3.8188300000000002 facet_computeNormals
opspareds "" facet_computeNormals
opparm -V 15.0.416 facet_computeNormals group ( "" ) prenml ( off ) unit ( off ) unique ( off ) cons ( none ) dist ( 0.001 ) accurate ( on ) inline ( off ) inlinedist ( 0.001 ) orientPolys ( off ) cusp ( off ) angle ( 20 ) remove ( off ) mkplanar ( off ) postnml ( on ) reversenml ( off )
chlock facet_computeNormals -*
chautoscope facet_computeNormals -*
opcolor -c 0.80000001192092896 0.80000001192092896 0.80000001192092896 facet_computeNormals
opset -d off -r off -h off -f off -y off -t off -l off -s off -u off -c off -e on -b off facet_computeNormals
opexprlanguage -s hscript facet_computeNormals
opuserdata -n '___Version___' -v '15.0.416' facet_computeNormals

# Node attributeCreate_v1 (Sop/attribcreate::2.0)
opadd -e -n attribcreate::2.0 attributeCreate_v1
oplocate -x 10.8238 -y 2.8124600000000002 attributeCreate_v1
...
# Node tube (Sop/tube)
opadd -e -n tube tube
oplocate -x 3.8010100000000002 -y 6.0115400000000001 tube
opspareds "" tube
...
oplocate -x 3.8147799999999998 -y -4.5862499999999997 OUT_container
...
# Node wire1 (Sop/wire)
opadd -e -n wire wire1
oplocate -x 3.8147799999999998 -y -5.5811400000000004 wire1
opspareds "" wire1
opparm -V 15.0.416 wire1 group ( "" ) radius ( 0.050000000000000003 ) corners ( on ) caps ( off ) remove ( on )
chlock wire1 -*
chautoscope wire1 -*
opcolor -c 0.80000001192092896 0.80000001192092896 0.80000001192092896 wire1
opset -d off -r off -h off -f off -y off -t off -l off -s off -u off -c off -e on -b off wire1
opexprlanguage -s hscript wire1
opuserdata -n '___Version___' -v '15.0.416' wire1

# Node merge_surfaceAndContainer (Sop/merge)
opadd -e -n merge merge_surfaceAndContainer
oplocate -x 7.2141599999999997 -y -6.1803299999999997 merge_surfaceAndContainer
...
oplocate -x 14.222899999999999 -y -0.98066200000000003 attributeCreate_id
...
oplocate -x 3.8010100000000002 -y 5.2110399999999997 delete_topCap
...
oplocate -x 9.0215800000000002 -y 6.0158899999999997 tube1
opspareds "" tube1
...
oplocate -x 7.2141599999999997 -y 5.0138800000000003 delete_nonTop
...
oplocate -x 14.222899999999999 -y 1.2184699999999999 delete_nonDensity
...
oplocate -x 17.607199999999999 -y -0.57857099999999995 scatter_sourcePoints
opspareds "" scatter_sourcePoints
opparm -V 15.0.416 scatter_sourcePoints group ( "" ) stdswitcher ( 0 0 ) generateby ( bydensity ) densityscale ( 10 ) usedensityattrib ( off ) densityattrib ( density ) useareaattrib ( off ) areaattrib ( area ) forcetotal ( on ) npts ( 200 ) usedensitytexture ( off ) densitytexture ( default.pic ) primcountattrib ( count ) useemergencylimit ( on ) emergencylimit ( 1000000 ) seed ( 0 ) overrideprimseed ( off ) primseedattrib ( primid ) randomizeorder ( on ) relaxpoints ( on ) relaxiterations ( 10 ) scaleradiiby ( 1 ) usemaxradius ( on ) maxradius ( 10 ) useprimnumattrib ( off ) primnumattrib ( sourceprim ) useprimuvwattrib ( off ) primuvwattrib ( sourceprimuv ) useoutputdensityattrib ( off ) outputdensityattrib ( density ) useoutputradiusattrib ( off ) outputradiusattrib ( pscale ) radiusintexturespace ( off ) pointattribs ( * ) vertattribs ( "" ) primattribs ( "" ) detailattribs ( "" )
...
oplocate -x 19.6204 -y 6.0221600000000004 controls
opspareds '    parm { 	name	"copyinput" 	baseparm 	label	"Copy Input" 	invisible 	export	none     }     parm { 	name	"cacheinput" 	baseparm 	label	"Cache Input" 	invisible 	export	none     }     parm { 	name	"filmthickness" 	label	"Film Thickness" 	type	float 	default	{ "0" } 	range	{ 0 10 } 	export	none     }     parm { 	name	"airdensity" 	label	"Air Density" 	type	float 	default	{ "0" } 	range	{ 0 10 } 	export	none     }     parm { 	name	"liquiddensity" 	label	"Liquid Density" 	type	float 	default	{ "0" } 	range	{ 0 10 } 	export	none     }     parm { 	name	"sepparm" 	label	"Separator" 	type	separator 	default	{ "" } 	range	{ 0 1 } 	export	none     }     parm { 	name	"minpscale" 	label	"Min Pscale" 	type	float 	default	{ "0" } 	range	{ 0 10 } 	export	none     }     parm { 	name	"maxpscale" 	label	"Max Pscale" 	type	float 	default	{ "0" } 	range	{ 0 10 } 	export	none     }     parm { 	name	"pscale" 	label	"Pscale" 	type	ramp_flt 	default	{ "2" } 	range	{ 1! 10 } 	export	none     } ' controls
opparm controls  pscale ( 3 )
opparm -V 15.0.416 controls copyinput ( on ) cacheinput ( off ) filmthickness ( 0.050000000000000003 ) airdensity ( 0.001225 ) liquiddensity ( 1 ) sepparm ( ) minpscale ( 1 ) maxpscale ( 3.5 ) pscale ( 3 ) pscale1pos ( 0 ) pscale1value ( 0 ) pscale1interp ( linear ) pscale2pos ( 0.63562387228012085 ) pscale2value ( 0.3958333432674408 ) pscale2interp ( linear ) pscale3pos ( 1 ) pscale3value ( 1 ) pscale3interp ( catmull-rom )
chlock controls -*
...
# Node volume_testPoints (Sop/volume)
opadd -e -n volume volume_testPoints
oplocate -x 24.4193 -y 6.0146300000000004 volume_testPoints
opspareds "" volume_testPoints
opparm -V 15.0.416 volume_testPoints rank ( scalar ) name ( "" ) initialval ( 1 0 0 ) stdswitcher ( 0 0 ) dimensionsource ( 0 0 ) size ( 20 1 20 ) t ( 0 0 0 ) taper ( 1 1 ) twod ( off ) voxelplane ( xy ) camera ( "" ) zmin ( 1 ) zmax ( 2 ) usecamwindow ( on ) winx ( 0 1 ) winy ( 0 1 ) uniformsamples ( max ) samplediv ( 10 ) divs ( 10 10 10 ) divsize ( 0.10000000000000001 ) zscale ( 1 ) volborder ( constant ) volborderval ( 0 0 0 ) voltol ( 0 ) quantizetol ( 0 ) dither ( ordered ) usefp16 ( off ) volvis ( smoke ) volvisiso ( 0 ) volvisdensity ( 1 )
chlock volume_testPoints -*
chautoscope volume_testPoints -*
opcolor -c 0.80000001192092896 0.80000001192092896 0.80000001192092896 volume_testPoints
opset -d off -r off -h off -f off -y off -t off -l off -s off -u off -c off -e on -b off volume_testPoints
opexprlanguage -s hscript volume_testPoints
opuserdata -n '___Version___' -v '15.0.416' volume_testPoints

# Node scatter_testPoints (Sop/scatter::2.0)
opadd -e -n scatter::2.0 scatter_testPoints
oplocate -x 24.4193 -y 5.21441 scatter_testPoints
opspareds "" scatter_testPoints
opparm -V 15.0.416 scatter_testPoints group ( "" ) stdswitcher ( 0 0 ) generateby ( bydensity ) densityscale ( 10 ) usedensityattrib ( off ) densityattrib ( density ) useareaattrib ( off ) areaattrib ( area ) forcetotal ( on ) npts ( 200 ) usedensitytexture ( off ) densitytexture ( default.pic ) primcountattrib ( count ) useemergencylimit ( on ) emergencylimit ( 1000000 ) seed ( 0 ) overrideprimseed ( off ) primseedattrib ( primid ) randomizeorder ( on ) relaxpoints ( on ) relaxiterations ( 10 ) scaleradiiby ( 1 ) usemaxradius ( on ) maxradius ( 10 ) useprimnumattrib ( off ) primnumattrib ( sourceprim ) useprimuvwattrib ( off ) primuvwattrib ( sourceprimuv ) useoutputdensityattrib ( off ) outputdensityattrib ( density ) useoutputradiusattrib ( off ) outputradiusattrib ( pscale ) radiusintexturespace ( off ) pointattribs ( * ) vertattribs ( "" ) primattribs ( "" ) detailattribs ( "" )
...
oplocate -x 21.807700000000001 -y 3.2158000000000002 attributeCreate_pscaleNewPoints
...
chkey -t 0 -v 0 -m 0 -a 0 -A 0 -T a  -F 'fit01(chramp("../controls/pscale", rand($PT), 0), ch("../controls/minpscale"), ch("../controls/maxpscale"))' attributeCreate_pscaleNewPoints/value1v1
chblockend
...
oplocate -x 27.222300000000001 -y 2.8179599999999998 copy_testSpheres
...
opset -d off -r off -h off -f off -y off -t off -l off -s off -u off -c off -e on -b off copy_testSpheres
...
oplocate -x 27.222300000000001 -y 4.0186400000000004 sphere
opspareds "" sphere
...
# Node switch_testPointScales (Sop/switch)
opadd -e -n switch switch_testPointScales
oplocate -x 21.807700000000001 -y 4.0171200000000002 switch_testPointScales
opspareds "" switch_testPointScales
opparm -V 15.0.416 switch_testPointScales input ( 0 )
chlock switch_testPointScales -*
chautoscope switch_testPointScales -*
opcolor -c 0 0.2669999897480011 0 switch_testPointScales
opset -d off -r off -h off -f off -y off -t off -l off -s off -u off -c off -e on -b off switch_testPointScales
opexprlanguage -s hscript switch_testPointScales
opuserdata -n '___Version___' -v '15.0.416' switch_testPointScales
oporder -e scatter_initialPoints OUT_initialPoints vdbFromPolygons OUT_liquidVelocity attributeCreate_pscale OUT_emissionGeometry group_highVel bound_band delete_nonVelocity OUT_liquidSurface attributeCreate_massLiquid attributeCreate_volume attributeCreate_radius attributeCreate_massAir OUT_newPoints dopImport_newPoints facet_computeNormals attributeCreate_v1 tube OUT_container polyextrude1 facet_computeNormals1 attribcreate_idLocal wire1 merge_surfaceAndContainer attributeCreate_id delete_topCap tube1 delete_nonTop delete_nonDensity scatter_sourcePoints controls volume_testPoints scatter_testPoints attributeCreate_pscaleNewPoints copy_testSpheres sphere switch_testPointScales 
opcf ..
opcf DOPNetwork
...
opparm attributeCreate_multiple3  numattr ( 1 )
opparm -V 15.0.416 attributeCreate_multiple3 group ( "" ) grouptype ( guess ) numattr ( 1 ) enable1 ( on ) name1 ( airDistance ) existing1 ( better ) createvarmap1 ( on ) varname1 ( "" ) class1 ( point ) savetoinfo1 ( off ) type1 ( float ) typeinfo1 ( guess ) precision1 ( 32 ) size1 ( 1 ) default1v ( 0 0 0 0 ) writevalues1 ( on ) uselocal1 ( on ) value1v ( 100000000 0 0 0 ) string1 ( "" )
...
# Node remesh_decentPrecision (Sop/remesh)
opadd -e -n remesh remesh_decentPrecision
oplocate -x -1.17571 -y 9.0731099999999998 remesh_decentPrecision
opspareds "" remesh_decentPrecision
opparm remesh_decentPrecision  lfs_ramp ( 2 )
opparm -V 15.0.416 remesh_decentPrecision group ( "" ) hard_edges ( "" ) iterations ( 1 ) recompute_normals ( off ) smoothing_level ( 0 ) element_sizing ( 0 0 ) target_edge ( 0.5 ) input_pts_only ( off ) gradation ( 0.25 ) density ( 1 ) limit_below ( off ) min_edge_length ( 1.0000000000000001e-05 ) limit_above ( off ) max_edge_length ( 10000 ) lfs_only ( off ) visualize_lfs ( off ) lfs_ramp ( 2 ) lfs_ramp1pos ( 0 ) lfs_ramp1c ( 0 0 1 ) lfs_ramp1interp ( linear ) lfs_ramp2pos ( 1 ) lfs_ramp2c ( 1 0 0 ) lfs_ramp2interp ( linear )
chlock remesh_decentPrecision -*
chautoscope remesh_decentPrecision -*
opcolor -c 0.80000001192092896 0.80000001192092896 0.80000001192092896 remesh_decentPrecision
opset -d off -r off -h off -f off -y off -t off -l off -s off -u off -c off -e on -b off remesh_decentPrecision
opexprlanguage -s hscript remesh_decentPrecision
opuserdata -n '___Version___' -v '15.0.416' remesh_decentPrecision

# Node controls (Sop/null)
opadd -e -n null controls
oplocate -x 10.831 -y 8.0386600000000001 controls
opspareds '    parm { 	name	"copyinput" 	baseparm 	label	"Copy Input" 	invisible 	export	none     }     parm { 	name	"cacheinput" 	baseparm 	label	"Cache Input" 	invisible 	export	none     }     parm { 	name	"gravityon" 	label	"Label" 	type	toggle 	nolabel 	joinnext 	default	{ "1" } 	range	{ 0 1 } 	export	none     }     parm { 	name	"gravity" 	label	"Gravity" 	type	vector 	size	3 	default	{ "0" "0" "0" } 	disablewhen	"{ gravityon == 0 }" 	range	{ -1 1 } 	export	none     }     parm { 	name	"buoyancyon" 	label	"Label" 	type	toggle 	nolabel 	joinnext 	default	{ "1" } 	disablewhen	"{ gravityon == 0 }" 	range	{ 0 1 } 	export	none     }     parm { 	name	"buoyancy" 	label	"Buoyancy" 	type	float 	default	{ "0" } 	disablewhen	"{ gravityon == 0 } { buoyancyon == 0 }" 	range	{ 0 1 } 	export	none     }     parm { 	name	"surfacetensionon" 	label	"Label" 	type	toggle 	nolabel 	joinnext 	default	{ "1" } 	range	{ 0 1 } 	export	none     }     parm { 	name	"surfacetension" 	label	"SurfaceTension" 	type	float 	default	{ "0" } 	disablewhen	"{ surfacetensionon == 0 }" 	range	{ 0 1 } 	export	none     }     parm { 	name	"solidcollisionon" 	label	"Label" 	type	toggle 	nolabel 	joinnext 	default	{ "1" } 	range	{ 0 1 } 	export	none     }     parm { 	name	"solidcollision" 	label	"Solid Collision" 	type	float 	default	{ "0" } 	disablewhen	"{ solidcollisionon == 0 }" 	range	{ 0 1 } 	export	none     }     parm { 	name	"solidstronginteractionon" 	label	"Label" 	type	toggle 	nolabel 	joinnext 	default	{ "1" } 	range	{ 0 1 } 	export	none     }     parm { 	name	"solidstronginteraction" 	label	"Solid Strong Interaction" 	type	float 	default	{ "0" } 	disablewhen	"{ solidstronginteractionon == 0 }" 	range	{ 0 1 } 	export	none     }     parm { 	name	"solidattractionon" 	label	"Label" 	type	toggle 	nolabel 	joinnext 	default	{ "1" } 	range	{ 0 1 } 	export	none     }     parm { 	name	"solidattraction" 	label	"Solid Attraction" 	type	float 	default	{ "0" } 	disablewhen	"{ solidattractionon == 0 }" 	range	{ 0 1 } 	export	none     }     parm { 	name	"stronginteractionon" 	label	"Label" 	type	toggle 	nolabel 	joinnext 	default	{ "1" } 	range	{ 0 1 } 	export	none     }     parm { 	name	"stronginteraction" 	label	"Strong Interaction" 	type	float 	default	{ "0" } 	disablewhen	"{ stronginteractionon == 0 }" 	range	{ 0 1 } 	export	none     }     parm { 	name	"weakinteractionon" 	label	"Label" 	type	toggle 	nolabel 	joinnext 	default	{ "1" } 	range	{ 0 1 } 	export	none     }     parm { 	name	"weakinteraction" 	label	"Weak Interaction" 	type	float 	default	{ "0" } 	disablewhen	"{ weakinteractionon == 0 }" 	range	{ 0 1 } 	export	none     }     parm { 	name	"sepparm" 	label	"Separator" 	type	separator 	default	{ "" } 	range	{ 0 1 } 	export	none     }     parm { 	name	"dampingon" 	label	"Label" 	type	toggle 	nolabel 	joinnext 	default	{ "1" } 	range	{ 0 1 } 	export	none     }     parm { 	name	"damping" 	label	"Damping" 	type	float 	default	{ "0" } 	disablewhen	"{ dampingon == 0 }" 	range	{ 0 1 } 	export	none     }     parm { 	name	"generalscaleon" 	label	"Label" 	type	toggle 	nolabel 	joinnext 	default	{ "1" } 	range	{ 0 1 } 	export	none     }     parm { 	name	"generalscale" 	label	"General Scale" 	type	float 	default	{ "0" } 	disablewhen	"{ generalscaleon == 0 }" 	range	{ 0 1 } 	export	none     } ' controls
chblockbegin
...
chadd -t 0 0 controls solidcollisionon
chkey -t 0 -v 1 -m 0 -a 0 -A 0 -T a  -F 'ch("../../controls/solidcollisionon")' controls/solidcollisionon
chadd -t 0 0 controls solidcollision
chkey -t 0 -v 0 -m 0 -a 0 -A 0 -T a  -F 'ch("../../controls/solidcollision")' controls/solidcollision
...
oplocate -x -0.97497400000000001 -y -7.1781699999999997 group_closeSolid
...
oplocate -x 1.20644 -y -11.5839 group_contactSolidUpdate
...
oplocate -x 1.20644 -y -10.782999999999999 group_contactSolid
...
oplocate -x 1.21549 -y -13.2021 switch_solidStronInteraction
...
oplocate -x -0.97497400000000001 -y -10.1823 switch_solidAttraction
...
oplocate -x -2.58331 -y -15.5854 switch_solid
opspareds "" switch_solid
chblockbegin
chadd -t 0 0 switch_solid input
chkey -t 0 -v 0 -m 0 -a 0 -A 0 -T a  -F 'ch("../controls/solidcollisionon") || ch("../controls/solidattractionon") || ch("../controls/solidstronginteractionon")' switch_solid/input
chblockend
...
oplocate -x -0.97497400000000001 -y -7.7805799999999996 attributeCreate_solidDistance
...
# Node group_outsideUpdate (Sop/group)
opadd -e -n group group_outsideUpdate
oplocate -x -3.37717 -y -0.97946699999999998 group_outsideUpdate
opspareds "" group_outsideUpdate
chblockbegin
chadd -t 0 0 group_outsideUpdate rangeend
chkey -t 0 -v 0 -m 0 -a 0 -A 0 -T a  -F '$N' group_outsideUpdate/rangeend
chblockend
opparm -V 15.0.416 group_outsideUpdate group ( "" ) stdswitcher ( 1 1 1 ) docreategrp ( on ) crname ( outside ) entity ( point ) geotype ( all ) mergeop ( replace ) switcher2 ( 0 0 0 0 ) groupnumber ( on ) ordered ( off ) groupop ( grppattern ) filter ( 1 ) pattern ( "" ) range ( 0 rangeend ) select ( 1 2 ) groupbounding ( off ) boundtype ( usebbox ) size ( 1 1 1 ) t ( 0 0 0 ) iso ( 0 ) invertvolume ( off ) includenotwhollycontained ( off ) groupnormal ( off ) dir ( 0 0 1 ) angle ( 180 ) camerapath ( "" ) nonplanar ( off ) nonplanartol ( 0.001 ) groupedges ( off ) dominedgeangle ( off ) minedgeangle ( 20 ) domaxedgeangle ( off ) maxedgeangle ( 20 ) edgeanglebetweenedges ( off ) dominedgelen ( off ) minedgelen ( 0 ) domaxedgelen ( off ) maxedgelen ( 0 ) dodepth ( off ) edgestep ( 0 ) edgeptgrp ( 0 ) unshared ( off ) boundarygroups ( off ) combineentity ( guess ) grpequal ( outside ) not1 ( off ) grp1 ( outside ) op1 ( sub ) not2 ( off ) grp2 ( inLiquid ) op2 ( sub ) not3 ( off ) grp3 ( onSurface ) op3 ( sub ) not4 ( off ) grp4 ( inAir ) switcher3 ( 0 0 0 ) oldname ( "" ) newname ( "" ) cnvfromtype ( primgroup ) cnvtotype ( ptgroup ) convertg ( "" ) cnvtname ( "" ) preserve ( off ) primswithallpts ( off ) destroyname ( "" ) type ( 1 )
chlock group_outsideUpdate -*
chautoscope group_outsideUpdate -*
opcolor -c 0.80000001192092896 0.80000001192092896 0.80000001192092896 group_outsideUpdate
opset -d off -r off -h on -f off -y off -t off -l off -s off -u off -c off -e on -b off group_outsideUpdate
opexprlanguage -s hscript group_outsideUpdate
opuserdata -n '___Version___' -v '15.0.416' group_outsideUpdate

# Node group_outside1 (Sop/group)
opadd -e -n group group_outside1
oplocate -x -6.0024100000000002 -y 1.22262 group_outside1
opspareds "" group_outside1
chblockbegin
chadd -t 0 0 group_outside1 rangeend
chkey -t 0 -v 0 -m 0 -a 0 -A 0 -T a  -F '$N' group_outside1/rangeend
chblockend
opparm -V 15.0.416 group_outside1 group ( "" ) stdswitcher ( 0 0 0 ) docreategrp ( on ) crname ( outside ) entity ( point ) geotype ( all ) mergeop ( replace ) switcher2 ( 0 0 0 0 ) groupnumber ( on ) ordered ( off ) groupop ( grpexpression ) filter ( 1 ) pattern ( "" ) range ( 0 rangeend ) select ( 1 2 ) groupbounding ( off ) boundtype ( usebbox ) size ( 1 1 1 ) t ( 0 0 0 ) iso ( 0 ) invertvolume ( off ) includenotwhollycontained ( off ) groupnormal ( off ) dir ( 0 0 1 ) angle ( 180 ) camerapath ( "" ) nonplanar ( off ) nonplanartol ( 0.001 ) groupedges ( off ) dominedgeangle ( off ) minedgeangle ( 20 ) domaxedgeangle ( off ) maxedgeangle ( 20 ) edgeanglebetweenedges ( off ) dominedgelen ( off ) minedgelen ( 0 ) domaxedgelen ( off ) maxedgelen ( 0 ) dodepth ( off ) edgestep ( 0 ) edgeptgrp ( 0 ) unshared ( off ) boundarygroups ( off ) combineentity ( guess ) grpequal ( "" ) not1 ( on ) grp1 ( "" ) op1 ( none ) not2 ( on ) grp2 ( "" ) op2 ( none ) not3 ( off ) grp3 ( "" ) op3 ( none ) not4 ( off ) grp4 ( "" ) switcher3 ( 0 0 0 ) oldname ( "" ) newname ( "" ) cnvfromtype ( primgroup ) cnvtotype ( ptgroup ) convertg ( "" ) cnvtname ( "" ) preserve ( off ) primswithallpts ( off ) destroyname ( "" ) type ( 1 )
chlock group_outside1 -*
chautoscope group_outside1 -*
opcolor -c 0.80000001192092896 0.80000001192092896 0.80000001192092896 group_outside1
opset -d off -r off -h on -f off -y off -t off -l off -s off -u off -c off -e on -b off group_outside1
opexprlanguage -s hscript group_outside1
opuserdata -n '___Version___' -v '15.0.416' group_outside1

# Node switch_solidCollision (Sop/switch)
opadd -e -n switch switch_solidCollision
oplocate -x 1.21549 -y -15.5832 switch_solidCollision
opspareds "" switch_solidCollision
chblockbegin
chadd -t 0 0 switch_solidCollision input
chkey -t 0 -v 0 -m 0 -a 0 -A 0 -T a  -F 'ch("../controls/solidcollisionon")' switch_solidCollision/input
chblockend
opparm -V 15.0.416 switch_solidCollision input ( input )
chlock switch_solidCollision -*
chautoscope switch_solidCollision -*
opcolor -c 0 0.2669999897480011 0 switch_solidCollision
opset -d off -r off -h off -f off -y off -t off -l off -s off -u off -c off -e on -b off switch_solidCollision
opexprlanguage -s hscript switch_solidCollision
opuserdata -n '___Version___' -v '15.0.416' switch_solidCollision

# Node switch_positionBased (Sop/switch)
opadd -e -n switch switch_positionBased
oplocate -x 2.2242600000000001 -y -14.981400000000001 switch_positionBased
opspareds "" switch_positionBased
opparm -V 15.0.416 switch_positionBased input ( 1 )
chlock switch_positionBased -*
chautoscope switch_positionBased -*
opcolor -c 0 0.2669999897480011 0 switch_positionBased
opset -d off -r off -h off -f off -y off -t off -l off -s off -u off -c off -e on -b off switch_positionBased
opexprlanguage -s hscript switch_positionBased
opuserdata -n '___Version___' -v '15.0.416' switch_positionBased
oporder -e dopImport_previousFrame connectAdjacentPieces attributeWrangle_orientForce attributeWrangle_strongInteraction attributeWrangle_restlength attributeWrangle_link attributeWrangle_weakInteraction attributeWrangle_lengthWeak attributeWrangle_inLiquid attributeWrangle_inAir attributeWrangle_buoyancy attributeWrangle_surfaceTension color_strongInteraction color_weakInteraction attributeWrangle_onSurfaceForces attributeWrangle_inLiquidForces attributeWrangle_inAirForces attributeWrangle_deletePreviousForces attributeWrangle_gravity attributeWrangle_damping OUT attributePromote_Pi attributePromote_Pj attributeCreate_sign attributePromote_strongInteractionToVertex attributePromote_strongInteractionUpToPoint delete_allPrimitives attributePromote_Ri attributePromote_Rj delete_nonRelevant attributesCreate_mutiple group_weakInteraction tetrahedralize_connectNeighbours group_strongInteraction attributePromote_weakInteractionToVertex attributePromote_weakInteractionUpToPoint attributeDelete_vertexAttributes attributePromote_minLinkLength attributePromote_selectedMinLength delete_nonInteraction group_weakInteractionUpdate2 group_strongInteractionUpdate group_weakInteractionUpdate objectMerge_liquidSurface ray_inLiquid ray_inAir attributeDelete_vertexAttributes2 ray_liquidToBubbles transform1 group_onSurface sphere1 copy1 ray_onSurface group_updateOnSurface attributeCreate_dist group_updateInAir group_updateInLiquid group_delete attributeCreate_multiple3 remesh_decentPrecision attributeWrangle_displacedVolumeSurface attributeWrangle_displacedVolumeLiquid controls objectMerge_container ray_onSurfaceToSolid ray_FromContainerToSpheres group_closeSolid attribute_idToPointId attributeCreate_pointIdLocal attributeWrangle_distNull attributeWrangle_solidAttraction point_pointId point_toSolid attributeCreate_toSolid attributeCreate_originalPoint attributeWrangle_toSolid group_contactSolidUpdate group_contactSolid attributeWrangle_solidStrongInteraction switch_gravity switch_buoyancy switch_surfaceTension switch_solidStronInteraction switch_solidAttraction switch_strongInteraction switch_weakInteraction switch_damping switch_generalScale attributeWrangle_generalScale switch_solid attributeCreate_solidDistance attributeWrangle_solidDistance group_outsideUpdate attributeWrangle_outside group_outside1 attributeWrangle_solidCollision switch_solidCollision switch_positionBased pointWrangle_projectToSolid 
opcf ..

# Node numbers (Object/geo)
opadd -e -n geo numbers
oplocate -x 9.3643999999999998 -y 9.0822099999999999 numbers
...
opparm -V 15.0.416 ipr_camera stdswitcher ( 0 0 ) keeppos ( off ) childcomp ( off ) pre_xform ( clean ) xOrd ( srt ) rOrd ( xyz ) t ( 2.8106770590382752 2.2949082087967478 2.8106770590382757 ) r ( -29.999999999999996 44.999999999999993 -8.9959671327898885e-15 ) s ( sx sy sz ) p ( 0 0 0 ) scale ( scale ) lookatpath ( "" ) lookupobjpath ( "" ) lookup ( on ) pathobjpath ( "" ) roll ( 0 ) pos ( 0 ) uparmtype ( arc ) pathorient ( 1 ) up ( 0 1 0 ) bank ( 0 ) tdisplay ( off ) display ( 1 ) use_dcolor ( off ) dcolor ( 1 1 1 ) picking ( on ) pickscript ( "" ) caching ( off ) stdswitcher3 ( 0 0 0 0 ) iconscale ( 1 ) res ( 1280 720 ) resMenu ( "640 480 1" ) aspect ( 1 ) projection ( perspective ) vm_lensshader ( "" ) focal ( 50 ) focalunits ( mm ) aperture ( 41.421398162841797 ) orthowidth ( 2.9739043032929322 ) near ( 0.10000000149011612 ) far ( 3898.6529086324131 ) vm_bgenable ( on ) vm_background ( "" ) win ( 0 0 ) winsize ( 1 1 ) winmask ( "" ) cropl ( 0 ) cropr ( 1 ) cropb ( 0 ) cropt ( 1 ) cropmask ( "" ) shutter ( 0.5 ) focus ( 5 ) fstop ( 5.5999999999999996 ) vm_bokeh ( radial ) vm_bokehfile ( default.pic ) vm_bokehrotation ( 0 )
chlock ipr_camera -*
...
opparm -V 15.0.416 ipr_camera1 stdswitcher ( 0 0 ) keeppos ( off ) childcomp ( off ) pre_xform ( clean ) xOrd ( srt ) rOrd ( xyz ) t ( 2.8106770590382752 2.2949082087967478 2.8106770590382757 ) r ( -29.999999999999996 44.999999999999993 -8.9959671327898885e-15 ) s ( sx sy sz ) p ( 0 0 0 ) scale ( scale ) lookatpath ( "" ) lookupobjpath ( "" ) lookup ( on ) pathobjpath ( "" ) roll ( 0 ) pos ( 0 ) uparmtype ( arc ) pathorient ( 1 ) up ( 0 1 0 ) bank ( 0 ) tdisplay ( off ) display ( 1 ) use_dcolor ( off ) dcolor ( 1 1 1 ) picking ( on ) pickscript ( "" ) caching ( off ) stdswitcher3 ( 0 0 0 0 ) iconscale ( 1 ) res ( 1280 720 ) resMenu ( "640 480 1" ) aspect ( 1 ) projection ( perspective ) vm_lensshader ( "" ) focal ( 50 ) focalunits ( mm ) aperture ( 41.421398162841797 ) orthowidth ( 2.9739043032929322 ) near ( 0.10000000149011612 ) far ( 3898.6529086324131 ) vm_bgenable ( on ) vm_background ( "" ) win ( 0 0 ) winsize ( 1 1 ) winmask ( "" ) cropl ( 0 ) cropr ( 1 ) cropb ( 0 ) cropt ( 1 ) cropmask ( "" ) shutter ( 0.5 ) focus ( 5 ) fstop ( 5.5999999999999996 ) vm_bokeh ( radial ) vm_bokehfile ( default.pic ) vm_bokehrotation ( 0 )
chlock ipr_camera1 -*
...
opparm -V 15.0.416 ipr_camera2 stdswitcher ( 0 0 ) keeppos ( off ) childcomp ( off ) pre_xform ( clean ) xOrd ( srt ) rOrd ( xyz ) t ( 2.8106770590382752 2.2949082087967478 2.8106770590382757 ) r ( -29.999999999999996 44.999999999999993 -8.9959671327898885e-15 ) s ( sx sy sz ) p ( 0 0 0 ) scale ( scale ) lookatpath ( "" ) lookupobjpath ( "" ) lookup ( on ) pathobjpath ( "" ) roll ( 0 ) pos ( 0 ) uparmtype ( arc ) pathorient ( 1 ) up ( 0 1 0 ) bank ( 0 ) tdisplay ( off ) display ( 1 ) use_dcolor ( off ) dcolor ( 1 1 1 ) picking ( on ) pickscript ( "" ) caching ( off ) stdswitcher3 ( 0 0 0 0 ) iconscale ( 1 ) res ( 1280 720 ) resMenu ( "640 480 1" ) aspect ( 1 ) projection ( perspective ) vm_lensshader ( "" ) focal ( 50 ) focalunits ( mm ) aperture ( 41.421398162841797 ) orthowidth ( 2.9739043032929322 ) near ( 0.10000000149011612 ) far ( 3898.6529086324131 ) vm_bgenable ( on ) vm_background ( "" ) win ( 0 0 ) winsize ( 1 1 ) winmask ( "" ) cropl ( 0 ) cropr ( 1 ) cropb ( 0 ) cropt ( 1 ) cropmask ( "" ) shutter ( 0.5 ) focus ( 5 ) fstop ( 5.5999999999999996 ) vm_bokeh ( radial ) vm_bokehfile ( default.pic ) vm_bokehrotation ( 0 )
chlock ipr_camera2 -*
...
oporder -e camOrigin file1 xform1 
opcf ..
oporder -e inputs DOPNetwork shapes forces numbers controls ipr_camera ipr_camera1 ipr_camera2 
opcf ..
...
opwire -n facet_computeNormals -0 OUT_liquidSurface
...
opwire -n delete_nonTop -0 facet_computeNormals
opwire -n group_highVel -0 attributeCreate_v1
opwire -n facet_computeNormals1 -0 OUT_container
opwire -n delete_topCap -0 polyextrude1
opwire -n polyextrude1 -0 facet_computeNormals1
opwire -n attributeCreate_massAir -0 attribcreate_idLocal
opwire -n OUT_container -0 wire1
opwire -n wire1 -0 merge_surfaceAndContainer
...
opwire -n vdbFromPolygons -0 delete_nonDensity
opwire -n delete_nonDensity -0 scatter_sourcePoints
opwire -n volume_testPoints -0 scatter_testPoints
opwire -n switch_testPointScales -0 attributeCreate_pscaleNewPoints
opwire -n sphere -0 copy_testSpheres
opwire -n attributeCreate_pscaleNewPoints -1 copy_testSpheres
opwire -n dopImport_newPoints -0 switch_testPointScales
opwire -n scatter_testPoints -1 switch_testPointScales
opcf ..
opcf DOPNetwork
...
opwire -n attributeWrangle_outside -0 color_strongInteraction
...
opwire -n group_outside1 -0 ray_inLiquid
opwire -n remesh_decentPrecision -1 ray_inLiquid
opwire -n attributeWrangle_inLiquid -0 ray_inAir
opwire -n remesh_decentPrecision -1 ray_inAir
...
opwire -n remesh_decentPrecision -0 transform1
...
opwire -n objectMerge_liquidSurface -0 remesh_decentPrecision
...
opwire -n group_outsideUpdate -0 attributeCreate_pointIdLocal
opwire -n attributeCreate_toSolid -0 attributeWrangle_distNull
opwire -n attributeWrangle_solidDistance -0 attributeWrangle_solidAttraction
opwire -n point_toSolid -0 point_pointId
opwire -n ray_FromContainerToSpheres -1 point_pointId
opwire -n attributeCreate_originalPoint -0 point_toSolid
...
opwire -n switch_solidAttraction -0 group_contactSolid
opwire -n group_contactSolidUpdate -0 attributeWrangle_solidStrongInteraction
...
opwire -n group_contactSolidUpdate -0 switch_solidStronInteraction
opwire -n attributeWrangle_solidStrongInteraction -1 switch_solidStronInteraction
opwire -n attributeWrangle_solidDistance -0 switch_solidAttraction
...
opwire -n group_outsideUpdate -0 switch_solid
opwire -n switch_solidCollision -1 switch_solid
...
opwire -n group_updateInLiquid -0 group_outsideUpdate
opwire -n attributeWrangle_inAirForces -0 attributeWrangle_outside
opwire -n attributeCreate_multiple3 -0 group_outside1
opwire -n switch_solidStronInteraction -0 attributeWrangle_solidCollision
opwire -n switch_solidStronInteraction -0 switch_solidCollision
opwire -n switch_positionBased -1 switch_solidCollision
opwire -n attributeWrangle_solidCollision -0 switch_positionBased
opwire -n pointWrangle_projectToSolid -1 switch_positionBased
opwire -n switch_solidStronInteraction -0 pointWrangle_projectToSolid
opcf ..
opcf numbers
